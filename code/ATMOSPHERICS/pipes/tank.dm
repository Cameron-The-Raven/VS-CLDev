...
/obj/machinery/atmospherics/pipe/tank/carbon_dioxide/Initialize()
	...
	air_temporary.adjust_gas(REAGENT_ID_CARBON_DIOXIDE, (start_pressure)*(air_temporary.volume)/(R_IDEAL_GAS_EQUATION*air_temporary.temperature))
...
/obj/machinery/atmospherics/pipe/tank/phoron/Initialize()
	...
	air_temporary.adjust_gas(REAGENT_ID_PHORON, (start_pressure)*(air_temporary.volume)/(R_IDEAL_GAS_EQUATION*air_temporary.temperature))
