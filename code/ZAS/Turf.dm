...
/turf/return_air()
	...
	GM.adjust_multi(REAGENT_ID_OXYGEN, oxygen, REAGENT_ID_CARBON_DIOXIDE, carbon_dioxide, REAGENT_ID_NITROGEN, nitrogen, REAGENT_ID_PHORON, phoron)
...
/turf/remove_air(amount as num)
	...
	if(sum>0)
		GM.gas[REAGENT_ID_OXYGEN] = (oxygen/sum)*amount
		GM.gas[REAGENT_ID_CARBON_DIOXIDE] = (carbon_dioxide/sum)*amount
		GM.gas[REAGENT_ID_NITROGEN] = (nitrogen/sum)*amount
		GM.gas[REAGENT_ID_PHORON] = (phoron/sum)*amount
...
/turf/proc/make_air()
	...
	air.adjust_multi(REAGENT_ID_OXYGEN, oxygen, REAGENT_ID_CARBON_DIOXIDE, carbon_dioxide, REAGENT_ID_NITROGEN, nitrogen, REAGENT_ID_PHORON, phoron)
