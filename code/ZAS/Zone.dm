...
/zone/proc/dbg_data(mob/M)
	...
	for(var/g in air.gas)
		to_chat(M, "[SSchemistry.get_gas_name(g)]: [air.gas[g]]")
	to_chat(M, "P: [air.return_pressure()] kPa V: [air.volume]L T: [air.temperature]°K ([air.temperature - T0C]°C)")
	to_chat(M, "O2 per N2: [(air.gas[REAGENT_ID_NITROGEN] ? air.gas[REAGENT_ID_OXYGEN]/air.gas[REAGENT_ID_NITROGEN] : "N/A")] Moles: [air.total_moles]")
