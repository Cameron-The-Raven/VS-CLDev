...
/obj/item/tank/oxygen/examine(mob/user)
	. = ..()
	if(loc == user && (air_contents.gas[REAGENT_ID_OXYGEN] < 10))
...
/obj/item/tank/anesthetic/Initialize()
	...
	air_contents.gas[REAGENT_ID_NITROGEN] = (3*ONE_ATMOSPHERE)*70/(R_IDEAL_GAS_EQUATION*T20C) * N2STANDARD
...
/obj/item/tank/air/examine(mob/user)
	. = ..()
	if(loc == user && (air_contents.gas[REAGENT_ID_OXYGEN] < 1))
...
/obj/item/tank/phoron/Initialize()
	. = ..()
	src.air_contents.adjust_gas(REAGENT_ID_PHORON, (3*ONE_ATMOSPHERE)*70/(R_IDEAL_GAS_EQUATION*T20C))
...
/obj/item/tank/vox/Initialize()
	. = ..()
	air_contents.adjust_gas(REAGENT_ID_PHORON, (10*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*T20C)) //VOREStation Edit
...
/obj/item/tank/phoron/pressurized/Initialize()
	. = ..()
	adjust_scale(0.8)
	air_contents.adjust_gas(REAGENT_ID_PHORON, (7*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*T20C))
...
/obj/item/tank/emergency/oxygen/Initialize()
	. = ..()
	src.air_contents.adjust_gas(REAGENT_ID_OXYGEN, (10*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*T20C))

/obj/item/tank/emergency/oxygen/examine(mob/user)
	. = ..()
	if(loc == user && (air_contents.gas[REAGENT_ID_OXYGEN] < 0.2))
...
/obj/item/tank/emergency/nitrogen/Initialize()
	. = ..()
	src.air_contents.adjust_gas(REAGENT_ID_NITROGEN, (10*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*T20C))
...
/obj/item/tank/emergency/phoron/Initialize()
	. = ..()
	src.air_contents.adjust_gas(REAGENT_ID_PHORON, (10*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*T20C))
...
/obj/item/tank/nitrogen/examine(mob/user)
	. = ..()
	if(loc == user && (air_contents.gas[REAGENT_ID_NITROGEN] < 10))
...
/obj/item/tank/stasis/nitro_cryo/Initialize()
	. = ..()
	src.air_contents.adjust_gas_temp(REAGENT_ID_NITROGEN, (3*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*TN60C), TN60C)
