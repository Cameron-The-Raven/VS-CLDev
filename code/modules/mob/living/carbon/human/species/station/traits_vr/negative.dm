...
/datum/trait/negative/breathes/phoron
	...
	var_changes = list("breath_type" = REAGENT_ID_PHORON, "poison_type" = REAGENT_ID_OXYGEN, "ideal_air_type" = /datum/gas_mixture/belly_air/vox)
...
/datum/trait/negative/breathes/nitrogen
	...
	var_changes = list("breath_type" = REAGENT_ID_NITROGEN, "poison_type" = REAGENT_ID_OXYGEN, "ideal_air_type" = /datum/gas_mixture/belly_air/nitrogen_breather)
