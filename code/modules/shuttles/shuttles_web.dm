...
/obj/machinery/shuttle_sensor/proc/air_list()
	...
	if(total_moles)
		var/o2_level = environment.gas[REAGENT_ID_OXYGEN]/total_moles
		var/n2_level = environment.gas[REAGENT_ID_NITROGEN]/total_moles
		var/co2_level = environment.gas[REAGENT_ID_CARBON_DIOXIDE]/total_moles
		var/phoron_level = environment.gas[REAGENT_ID_PHORON]/total_moles
		var/unknown_level =  1-(o2_level+n2_level+co2_level+phoron_level)
		aircontents = list(\
			"pressure" = "[round(pressure,0.1)]",\
			REAGENT_ID_NITROGEN = "[round(n2_level*100,0.1)]",\
			REAGENT_ID_OXYGEN = "[round(o2_level*100,0.1)]",\
			REAGENT_ID_CARBON_DIOXIDE = "[round(co2_level*100,0.1)]",\
			REAGENT_ID_PHORON = "[round(phoron_level*100,0.01)]",\
